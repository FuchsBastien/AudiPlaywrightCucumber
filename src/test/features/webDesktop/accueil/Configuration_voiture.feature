Feature: Configuration_voiture
    ...
    Scenario: Configuration_voiture
        ...
        And Je verifie que le texte "Page - Bouton Decouvrir Audi Q4 e-tron - Page d'accueil" est de couleur "rgb(0, 0, 0)"
        ...
        And Je verifie que le texte "Page - Configurer Audi Q4 e-tron - Espace configuration" est de couleur "rgb(0, 0, 0)"
        ...
        And Je verifie que le texte "Page - Suivant (Interieur) - Espace configuration" est de couleur "rgb(255, 255, 255)"
