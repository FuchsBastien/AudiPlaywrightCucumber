Feature: je fais la manipulation de depart qui me permettra de payer un contrat d'entretien de ma Audi
    ...
    Scenario:Contrat_entretient
        ...
        And Je verifier que l'element "Page - Contrat entretient - Espace Entretenir Mon Audi" est affiche
        And Je verifier que l'element "Page - Souscrire un contrat d’entretien pour mon Audi - Espace Entretenir Mon Audi" est affiche
        ...
        And Je verifier que le texte "Page - Souscrire un contrat d’entretien pour mon Audi - Espace Entretenir Mon Audi" est de couleur "rgb(0, 0, 0)"
        Then Je clique sur "Page - Souscrire un contrat d’entretien pour mon Audi - Espace Entretenir Mon Audi"
        And Je verifier que l'element "Page - Souscrire - Espace Entretenir Mon Audi" est affiche
        And Je verifie que "Page - Souscrire - Espace Entretenir Mon Audi" affiche le texte "Souscrire"
        And Je verifier que le texte "Page - Souscrire - Espace Entretenir Mon Audi" est de couleur "rgb(0, 0, 0)"
        ...
        And Je verifier que l'element "Page - Message erreur - Espace Entretenir Mon Audi" est affiche
        ...
        And Je verifier que le texte "Page - Message erreur - Espace Entretenir Mon Audi" est de couleur "#bb0a30"